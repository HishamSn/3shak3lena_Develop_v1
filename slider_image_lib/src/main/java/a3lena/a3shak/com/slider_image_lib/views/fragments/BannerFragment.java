package a3lena.a3shak.com.slider_image_lib.views.fragments;
...
import a3lena.a3shak.com.slider_image_lib.banners.DrawableBanner;
...
import a3lena.a3shak.com.slider_image_lib.views.AdjustableImageView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (banner != null) {
            ...
            if (banner instanceof DrawableBanner) {
                ...
                Picasso.with(getContext()).load(drawableBanner.getDrawable()).resize(2000, 2000).centerInside().into(imageView);
            } else {
                ...
                if (remoteBanner.getErrorDrawable() == null && remoteBanner.getPlaceHolder() == null) {
                    Picasso.with(getActivity()).load(remoteBanner.getUrl()).resize(2000, 2000).centerInside().into(imageView);
                } else {
                    if (remoteBanner.getPlaceHolder() != null && remoteBanner.getErrorDrawable() != null) {
                        ...
                        Picasso.with(getActivity()).load(remoteBanner.getUrl()).resize(2000, 2000).centerInside().placeholder(remoteBanner.getPlaceHolder()).into(imageView);
                    }
                }
            }
