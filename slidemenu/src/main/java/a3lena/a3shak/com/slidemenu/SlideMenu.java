 ...
 */
package a3lena.a3shak.com.slidemenu;
...
import a3lena.a3shak.com.slidemenu.utils.ScrollDetectors;
...
public class SlideMenu extends ViewGroup {
    ...
    public SlideMenu(Context context, AttributeSet attrs, int defStyle) {
        ...
        setSecondaryShadowWidth(a.getDimension(
                R.styleable.SlideMenu_secondaryShadowWidth, 18));
    ...
    protected void resolveSlideMode() {
        ...
        switch (mSlideMode) {
            case MODE_SLIDE_WINDOW: {
                ...
                decorChild.setBackgroundColor(Color.parseColor("#babd16"));
