package a3lena.a3shak.com.sweet_dialog;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeFont(getContext(), mTitleTextView);
        changeFont(getContext(), mContentTextView);
        changeFont(getContext(), mConfirmButton);
        changeFont(getContext(), mCancelButton);
    ...
    public SweetAlertDialog setColorTitleText(int c){
        color = c;
        if (mTitleTextView != null && mTitleText != null) {
