package daboubi.khalid.faisalawe.com.countdownlib;
...
public class TickTockView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCircleDuration == DURATION_TOTAL && mStartTime != null) {
            long totalTime = mEndTime.getTime() - mStartTime.getTime();
     ...
     */
    public void start(Date endTime) {
...
//        }
        ...
        mTimer = new CountDownTimer(endTime.getTime() - mStartTime.getTime(), 16) {
            @Override
