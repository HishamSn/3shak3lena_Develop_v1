...
public class About extends BaseSlideMenuActivity {
    ...
    public void onContentChanged() {
        ...
        setSlideRole(R.layout.activity_about);
        setSlideRole(R.layout.layout_secondary_menu);
        mSlideMenu = getSlideMenu();
        util.changeTitle(this,"معلومات عنا");
        // Slider Toggle
        click_menu();
        init();
        changeFont();
//        getTerms();
    ...
    public void init(){
        ...
        title_about.setText("عن "+'"'+"عشاك علينا"+'"');
    }
            ...
            JsonObjectRequest jsonObjectRequest= new JsonObjectRequest(Constatns.MAIN_API + Constatns.SETTINGS,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                Log.e("terms", response.getString("AboutApp"));
                                txtTerms.setText(response.getString("AboutApp"));
